  ...
  return (
    <li className="group rounded-xl border border-brand-100 bg-brand-0 p-4 transition sm:p-5">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex flex-row gap-2">
          ...
          >
            <button
              type="button"
              className="inline-flex shrink-0 items-center gap-1.5 rounded-md border border-border bg-card px-2.5 py-1 text-xs font-medium text-muted-foreground transition hover:border-primary/40 hover:text-primary"
            >
              Editar
      ...
      <div className="mt-4 flex items-center gap-2">
        <Badge>Compromisso Eventual</Badge>
      </div>
    </li>
  );
};
